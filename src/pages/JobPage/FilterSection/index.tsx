import {
  ...
  const numberOfEmployeesData=['less than 5','less than 20','less than 100','greater than 100']
  ...
  <InputLabel id="demo-simple-select-autowidth-label">Employees</InputLabel>
          <Select
            labelId="demo-multiple-chip-label"
            id="demo-multiple-chip"
            multiple
            value={numberOfEmployees}
            onChange={(e)=>setNumberOfEmployees( typeof e.target.value === 'string' ? e.target.value.split(',') : e.target.value,)}
            input={<OutlinedInput id="select-multiple-chip" label="Roles" />}
            sx={{minWidth:'250px'}}
            renderValue={(selected) => (
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
  ...
  <InputLabel id="demo-simple-select-autowidth-label">Experience</InputLabel>
      ...
      <em>Experience</em>
            ...
            {uniqueJobExperience.map((exp, index) => (
              <MenuItem sx={{ minWidth:'250px',width: "100%" }} key={index} value={exp}>
                {exp}
              </MenuItem>
            ))}
          </Select>
  ...
  <InputLabel id="demo-simple-select-autowidth-label">Location</InputLabel>
      ...
      <em>Location</em>
          ...
          <Select
             ...
             id="demo-multiple-chip"
            value={minsalary}
            onChange={(e) => setMinsalary(e.target.value as number)}
            autoWidth
            label="Base Pay"
            sx={{ minWidth: "250px" }}
